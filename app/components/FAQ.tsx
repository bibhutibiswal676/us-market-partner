      ...
      {isSectioned(items) ? (
        items.map((section, sIdx) => (
          <div key={sIdx} className="mb-8">
            ...
            <div className="divide-y divide-gray-200 rounded-xl border border-gray-200 bg-white/60 backdrop-blur">
              {section.items.map((qa, i) => {
                const isOpen = open === i + sIdx * 1000; // unique key per section
                ...
                return (
                  <div key={i} className="group">
                    <button
                      ...
                      onClick={() => setOpen(isOpen ? null : i + sIdx * 1000)}
